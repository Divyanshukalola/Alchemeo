...
function dropDown(e) {
    if (!document.querySelector(".dropdown-hover")) {
        ...
        for (var t = e.parentElement.parentElement.children, n = 0; n < t.length; n++)
            t[n].lastElementChild != e.parentElement.lastElementChild && t[n].lastElementChild.classList.remove("show");
...
function sidebarColor(e) {
    for (var t = e.parentElement.children, n = e.getAttribute("data-color"), a = 0; a < t.length; a++)
...
function sidebarType(e) {
    for (var t = e.parentElement.children, n = e.getAttribute("data-class"), a = 0; a < t.length; a++)
        t[a].classList.remove("active");
    e.classList.contains("active") ? e.classList.remove("active") : e.classList.add("active");
...
function navbarBlurOnScroll(e) {
    ...
    , 10),
    -1 < navigator.platform.indexOf("Win") && (n = document.querySelector(".main-content"),
    "true" == e ? n.addEventListener("ps-scroll-y", debounce(function() {
        (5 < n.scrollTop ? l : o)()
